		            ...
		            <tbody>
		             	<tr>
			                <td class="pro-thumbnail">
			                    <a href="#">
			                        <img class="img-fluid center-block" src="<?= base_url() ?>assets/front/images/product-img1.png" alt="Product">
			                    </a>
			                </td>
		        		...
		        		<tr>
			                <td class="pro-thumbnail">
			                    <a href="#">
			                        <img class="img-fluid center-block" src="<?= base_url() ?>assets/front/images/product-img2.png" alt="Product">
			                    </a>
			                </td>
			                <td class="pro-title"><a href="#">Brothel Token</a></td>
			                <td class="pro-price"><span>$65.00</span></td>
  		...
  		<div class="col-lg-4 col-md-4 col-12">
			<div class="order-summary-card">
				...
				<div class="summary-group">
					...
					<a href="checkout.php" class="custom_btn">Checkout &nbsp;<i class="fas fa-chevron-right"></i>
					</a>
				</div>
			</div>	
  		</div>
