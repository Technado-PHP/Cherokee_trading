...
<body class="hold-transition login-page" style="background-image: url(<?php echo base_url();?>assets/admin/img/banner-img-4.jpg);background-repeat: no-repeat; background-position: center;
