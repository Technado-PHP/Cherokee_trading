        ...
        <ul class="nav navbar-nav">
         <li class="user user-menu">
            <a href="<?php echo base_url('admin/profile');?>">
              <img src="<?php echo !empty($this->master_admin_image)?base_url('uploads/admin/').$this->master_admin_image:base_url('assets/admin/img/placeholder.png');?>" class="user-image" alt="User Image">
