...
<head>
  ...
  <title><?php echo $this->site_title.' | Forgot Password?';?></title>
...
<body class="hold-transition login-page" style="background-image: url(<?php echo base_url();?>assets/front/index-sec-5-bg.jpg);background-repeat: no-repeat; background-position: center;
