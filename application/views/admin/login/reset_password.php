...
<head>
  ...
  <title><?php echo $this->site_title.' | Reset Password';?></title>
...
<body class="hold-transition login-page" style="background-image: url(<?php echo base_url();?>assets/front/index-sec-5-bg.jpg);">
